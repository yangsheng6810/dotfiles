...
* persp-mode
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'spacemacs-post-user-config-hook
              (lambda ()
                (defhydra spacemacs/layouts-transient-state (:hint nil)
                             "\n\n
     Go to^^^^^^                                  Actions^^
     ─────^^^^^^────────────────────────────────  ───────^^──────────────────────────────────────────────────
     ...
     [_B_]^^^^        ibuffer in layout           [_X_]^^   kill other w/buffers
     ...
     ^^^^^^                                       [_?_]^^   toggle help\n"
                ...
                (spacemacs/set-leader-keys "l" 'spacemacs/layouts-transient-state/body)) t)
  #+END_SRC
