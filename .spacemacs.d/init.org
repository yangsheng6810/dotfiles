   ...
   #+BEGIN_SRC emacs-lisp
     (condition-case err
         (use-package ol-notmuch
           :after org)
       (message "Require of ol-notmuch failed as expected."))
...
** yadm
   #+BEGIN_SRC emacs-lisp
     ...
     (defun yadm-magit-status ()
       (interactive)
       (push (lambda () (projectile-mode -1)) magit-mode-hook)
       (magit-status "/yadm::")
       (setq magit-mode-hook (cdr magit-mode-hook)))
   #+END_SRC
