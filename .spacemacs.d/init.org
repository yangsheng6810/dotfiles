  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package js2-mode
      ...
      :bind (:map js2-mode-map
                  ("M-j" . nil)))
    (defun yang/evil-org-mode-func ()
      (mapc (lambda (state)
              (evil-define-key evil-state evil-org-mode-map
                (kbd "M-h") nil
                (kbd "M-j") nil
                (kbd "M-k") nil
                (kbd "M-l") nil
    ...
    (with-eval-after-load 'org
      (add-hook 'evil-org-mode-hook #'yang/evil-org-mode-func))
  #+END_SRC
         ...
         (when (null notmuch-refresh-timer)
           (setq notmuch-refresh-timer
                 (run-at-time
                  30 nil
                  (lambda ()
                    (start-process "mail-sync.sh" "*mail-sync*" "mail-sync.sh")
