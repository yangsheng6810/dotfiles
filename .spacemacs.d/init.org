...
(use-package ivy
  ...
  (general-def :keymaps 'ivy-minibuffer-map "C-k" nil))
   #+end_src
...
(when (display-graphic-p)
  ...
  (create-fontset-from-ascii-font "-*-Bookerly-normal-normal-normal-*-19-*" nil "variable")
...
"
  ...
  (define-advice elfeed-show-mode (:override () yang)
