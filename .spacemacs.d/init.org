...
(defun yang/fix-line-number ()
  ...
  ;; (set-face-attribute 'fixed-pitch nil :family "等距更纱黑体 SC" :height 'unspecified)
...
(new-fontset "-*-*-*-*-*-*-*-*-*-*-*-*-fontset--fixed-pitch" '((ascii . "Sarasa Mono SC")
                                                               (unicode . "Sarasa Mono SC")))
...
(defun yang/elfeed-new-entry-parse (type xml entry)
  ...
  (set-face-attribute 'elfeed-search-title-face nil :font "fontset--fixed-pitch")
"
