...
** Sending
   #+BEGIN_SRC emacs-lisp
     ...
     (with-eval-after-load 'markdown-mode
       (dolist (key '("M-h" "M-j" "M-k" "M-l" "M-H" "M-J" "M-K" "M-L"))
         (evil-define-key 'normal markdown-mode-map (kbd key) nil)
         (evil-define-key 'insert markdown-mode-map (kbd key) nil)))
   #+END_SRC
